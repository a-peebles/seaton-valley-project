 ...
 * <p>
 * This class extends the WebViewClient.
 * <p>
 * It's used to apply custom formating for the relevant links and manage the progress bar.
 * <p>
 * These variables: Type = 0 News/Events Articles, Type = 1 Weather Forecast, are used to determine whether or not, to apply formatting and
 * what kind of formatting to apply. The formatting is applied with JavaScript
 * and some jQuery with the websites structure that were found on 26.03.2018.
 * <p>
    ...
    public void onPageFinished(@NonNull WebView view, @NonNull String url) {
        ...
        if (type == 0 && !launched) {
            view.loadUrl("javascript:(function() { " +
                    ...
                    //Hides all the content expect the post
                    ...
                    "})()");
            //Makes the WebView visible to show the formated page.
            view.setVisibility(View.VISIBLE);
            progressBar.setVisibility(View.GONE);
            //Sets that the formating was applied and that it was launched.
            launched = true;
            //If its for the Weather Forecast and the url matches the weather forecast link,appllies formating
