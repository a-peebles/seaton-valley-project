...
public class MainActivityComponent extends GetPosts {
     ...
     * Extends the GetPosts class.
     * <p>
     * Gets the content of the Main Activity by calling the appropriate methods .
     *
     * @author Stelios Ioannou
     * @since 20/03/2018
     * Edited on: 2/03/2018 by Stelios Ioannou
    ...
    //Gets the 3 latests news posts.
    private void getLatestNews() {
        getPosts(3, "16", this);
    }

    /**
     * Gets the weather of Seaton Valley and updates the UI contents.
     *
     * @author Alex Peebles
     * @since 23/02/2018
