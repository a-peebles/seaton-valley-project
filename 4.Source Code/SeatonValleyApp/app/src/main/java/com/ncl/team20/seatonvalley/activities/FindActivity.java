 ...
 * <p>
 * This class is used to display the Places categories and set them their respective listeners.
 */
public class FindActivity extends Drawer {
    ...
    //Sets the Categories Listeners passes extra intent information to determine what kind of places to retrieve.
