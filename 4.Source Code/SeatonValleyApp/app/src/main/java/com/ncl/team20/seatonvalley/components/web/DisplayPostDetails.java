 ...
 * @since 20/02/2018
 * Last Edit: 27/03/2018 by Stelios Ioannou
 * <p>
...
public class DisplayPostDetails extends Connection {
    ...
    //Button for the Add Event
    private Button addEvent;
    //Progress Bar to Indicate the loading of the post.
    ...
    //Actions to Perform for the ‘Latest News' feature.
    ...
    //Actions to Perform for the ‘News' feature.
    private void news() {
        if (detector.isInternetAvailable()) {
            //Gets the Url and Loads into the Webview.
    ...
    //Actions to Perform for the ‘Events' feature.
    private void events() {
